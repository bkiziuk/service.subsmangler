...
class TmpFormat(FormatBase):
    ...
    def from_file(cls, subs, fp, format_, **kwargs):
        ...
        for line in fp:
            ...
            #calculate endtime from starttime + 2 seconds + 0.5 second per each space in string (which should roughly equal number of words)
            end = start + 2000 + (500 * line.count(" "))
