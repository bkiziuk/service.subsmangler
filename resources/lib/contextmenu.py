...
def main():
    ...
    if xbmc.getCondVisibility('ListItem.IsFolder'):
        ...
        if (xbmcvfs.exists(os.path.join(filepathname, "noautosubs"))):
            common.Log("'noautosubs' file exists: " + os.path.join(filepathname, "noautosubs   Opening YesNoDialog."),
                       xbmc.LOGDEBUG)
            ...
            common.Log("'noautosubs' file does not exist in: " + filepathname + "   Opening YesNoDialog.",
                       xbmc.LOGDEBUG)
            YesNoDialog = xbmcgui.Dialog().yesno("Subtitles Mangler", __addonlang__(
                32108) + "\n" + filepathname + "\n" + __addonlang__(32106),
                                                 nolabel=__addonlang__(32042),
        ...
        if (xbmcvfs.exists(os.path.join(filepath, "noautosubs"))):
            common.Log("'noautosubs' file exists: " + os.path.join(filepath, "noautosubs   Opening Ok dialog."),
                       xbmc.LOGDEBUG)
